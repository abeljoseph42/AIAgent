...
import { NavigationContext, NavigationProvider } from "@/lib/NavigationProvider";
import { useContext } from 'react';
function Header() {
    const { isMobileNavOpen, setIsMobileNavOpen } = useContext(NavigationContext);
    console.log("Header isMobileNavOpen:", isMobileNavOpen);
